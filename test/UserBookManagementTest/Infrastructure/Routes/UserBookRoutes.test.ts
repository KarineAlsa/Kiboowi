...
describe('UserBookRouter', () => {
  it('responds with status 200 and a list of reading books', async () => {
    const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywibmFtZSI6IkthcmluZSBBbGNhemFyIFNhcm1pZW50byIsInVzZXJuYW1lIjoia2FyaWFsc2EiLCJlbWFpbCI6IjIxMzM0MEBkcy51cGNoaWFwYXMuZWR1Lm14IiwiYmlydGhkYXkiOiIyMDAyLTExLTI5IiwiY3JlYXRlRGF0ZSI6IjIwMjQtMDMtMTgiLCJpYXQiOjE3MTE3NjI4MzIsImV4cCI6MTcxMTc2NjQzMn0.zYpLHYjoWGenZgVzyCvCQfuSls0Cw6Wg1YoF_xm5OoI';
  ...
  it('responds with status 200 and success message after adding a book', async () => {
    ...
    expect(response.body.data).toBeDefined();
    expect(response.body.data.idBook).toBe(2002); 
  });  
